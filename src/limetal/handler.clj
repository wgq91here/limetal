...
(defn destroy
  ...
  []
  (timbre/info "limetal is shutting down...")
  (stop-nrepl)
...
(def app-base
  (routes
    ...
    (wrap-routes #'webfront-routes middleware/wrap-csrf)
    (wrap-routes #'server-routes middleware/wrap-csrf)
    #'base-routes))
